...
const projects = [{
    ...
    {
        id: 4,
        title: 'Pavan Patil portfolio',
        category: 'Productivity',
        description: 'A problem-solver who loves building smart productivity tools with clean, structured UI/UX. Focused, detail-oriented, and always finding better ways to manage workflows.',
        icon: '🎓',
        status: 'live',
        tech: ['HTMl', 'CSS', 'JS', 'Bootstrap'],
        path: '../pavan patil portfolio/index.html',
        demoUrl: '#',
        githubUrl: '#'
    },
    {
        id: 5,
        title: 'Rahul Jagdale portfolio',
        category: 'Education',
        description: 'A self-driven developer passionate about creating simple, useful academic platforms. I focus on clean UI, smooth user experience, and solving real problems for students.',
        icon: '🎓',
        status: 'live',
        tech: ['HTMl', 'CSS', 'JS', 'Bootstrap'],
        path: '../Rahul portfolio/index.html',
        demoUrl: '#',
        githubUrl: '#'
    }
];
